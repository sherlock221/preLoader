...
;(function(exports){
    ...
    Loader.prototype = {
        ...
        _load: function() {
            if (this._index == this._source.length) return this._onend();
    ...
    var LoaderMsk = function(source, color, cb_end) {
        ...
        new Loader(source).loadstart(function() {}).loadend(function(percent) {
